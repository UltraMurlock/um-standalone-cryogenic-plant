...
local function cryogenic_plant_animation(name, frames, options)
  ...
  options['scale'] = 0.5
  return util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-".. name, options)
end
...
return {
  graphics_set = {
      ...
      frozen_patch = util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-frozen", {scale = 0.5}),
  ...
  pipe_picture = {
    north =
    {
      layers =
      {
        util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-v",
        {
          priority = "extra-high",
          scale = 0.5,
          shift = {0, 3}
        }),
        util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-shadow-v",
        {
          priority = "extra-high",
          draw_as_shadow = true,
          scale = 0.5,
    ...
    east =
    {
      layers =
      {
        util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-h",
        {
          priority = "extra-high",
          scale = 0.5,
          shift = {-3, 0}
        }),
        util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-shadow-h",
        {
          priority = "extra-high",
          draw_as_shadow = true,
          scale = 0.5,
  ...
  pipe_picture_frozen = {
    north =
    {
      layers =
      {
        util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-v-frozen",
        {
          priority = "extra-high",
          scale = 0.5,
          shift = {0, 3}
    ...
    east =
    {
      layers =
      {
        util.sprite_load("__um-standalone-cryogenic-plant__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-h-frozen",
        {
          priority = "extra-high",
          scale = 0.5,
          shift = {-3, 0}
